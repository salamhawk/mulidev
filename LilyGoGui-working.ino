...
lv_obj_t *setupGUI()
{
  RTC_Date tnow = watch->rtc->getDateTime(); //set real time 
    ...
    lv_label_set_text(hour, hhString);
    ...
    lv_label_set_text(minute, mmString);
    ...
    lv_label_set_text(second, ssString);
